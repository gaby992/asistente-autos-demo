...
// Marca del asistente (white-label: cambia aquí inicial, título y subtítulo).
const ASSISTANT_INITIAL = "M";
const HEADER_TITLE = "MAX";
const HEADER_SUBTITLE = "Asistente de Ventas";

const FIRST_MESSAGE =
  "¡Hola! Soy Max 👋 tu asistente de ventas. ¿Buscas auto nuevo o seminuevo?";

function Avatar({ small }: { small?: boolean }) {
  return <div className={small ? "avatar sm" : "avatar"}>{ASSISTANT_INITIAL}</div>;
}
    ...
    <section className="widget">
      <header className="header">
        ...
        <div className="header-text">
          ...
          <span className="header-subtitle">{HEADER_SUBTITLE}</span>
        </div>
        ...
        {loading && (
          <div className="row agent">
            ...
            <div className="bubble agent">
              <div className="typing" aria-label="Max está escribiendo">
                <span />
                <span />
                <span />
              </div>
